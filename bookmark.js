(async () => {
  const GEMINI_API_KEY = "AIzaSyBDdSZkgQphf5BORTDLcEUbJWcIAIo0Yr8"; // <-- coloque sua chave aqui
  ...
  const hasApiKey = !!GEMINI_API_KEY && GEMINI_API_KEY !== "AIzaSyBDdSZkgQphf5BORTDLcEUbJWcIAIo0Yr8";
